// Package bucketlist provides a Go client for the Bucket List API.
//
// For more information, visit: https://apiverve.com/marketplace/bucketlist?utm_source=go&utm_medium=readme
package bucketlist
...
const (
	baseURL        = "https://api.apiverve.com/v1/bucketlist"
	defaultTimeout = 30 * time.Second
)

// Client is the Bucket List API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Bucket List API client.
...
// Execute makes a request to the Bucket List API.
