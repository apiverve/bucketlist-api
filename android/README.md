...
```gradle
dependencies {
    implementation 'com.github.apiverve:bucketlist-api:1.1.13'
}
```
...
```java
import com.apiverve.bucketlist.BucketListAPIClient;
import com.apiverve.bucketlist.APIResponse;
import com.apiverve.bucketlist.APIException;

// Initialize the client
BucketListAPIClient client = new BucketListAPIClient("YOUR_API_KEY");

try {
    // Execute the request (no parameters required)
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/bucketlist](https://docs.apiverve.com/ref/bucketlist)
...
- **Documentation:** [https://docs.apiverve.com/ref/bucketlist](https://docs.apiverve.com/ref/bucketlist)
- **Issues:** [GitHub Issues](https://github.com/apiverve/bucketlist-api/issues)
