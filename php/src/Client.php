...
/**
 * Client for the Bucket List API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/bucketlist?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/bucketlist';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\BucketlistClient] {$message}\n";
        }
    }
}
