...
namespace APIVerve.API.BucketList
{
    /// <summary>
    ...
    /// <summary>
    /// Client for the BucketList API
    /// </summary>
    public class BucketListAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/bucketlist";
        ...
        public BucketListAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public BucketListAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public BucketListAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, BucketListQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(BucketListQueryOptions options)
        {
        ...
        public ResponseObj Execute(BucketListQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(BucketListQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(BucketListQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(BucketListQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(BucketListQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(BucketListQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(BucketListQueryOptions options)
        {
